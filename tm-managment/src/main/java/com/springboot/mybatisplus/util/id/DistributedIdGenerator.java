...
public class DistributedIdGenerator {
     ...
     */
    private static Integer UNIQUE_DATA_CENTER_ID = 5;

    private static Integer UNIQUE_WORK_ID = 3;
...
//        DistributedIdGenerator.initialize(5,5);
//        for (int i = 0; i <10000 ; i++) {
//            System.out.println(DistributedIdGenerator.generateId());
//        }
//    }
}
